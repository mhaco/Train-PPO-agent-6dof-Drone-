classdef Rocket_Lander < rl.env.MATLABEnvironment
...
% Copyright 2019 The MathWorks, Inc.
    ...
    methods
       % put your setup code here, to run once-Initiallization
        function this = Rocket_Lander(ActionInfo)
            
            % Define observation info
            
            % rlNumericSpec Create continuous action or observation data specifications
...
%  put your main code here, to run repeatedly: Applt system Dynamics &
%  simulate environment with given action for step
