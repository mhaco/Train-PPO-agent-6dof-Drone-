classdef RocketLander_6dof_Visualizer < rl.env.viz.AbstractFigureVisualizer
% ROCKETLANDERVISUALIZER Visualizer for RocketLander environment

% Copyright 2019 The MathWorks, Inc.

    methods
        function this = RocketLander_6dof_Visualizer(env)
    ...
    methods (Access = protected)
        ...
        function updatePlot(this)
            ...
            L1 = env.L1;
            L2 = env.L2;
            thrustLims = env.ThrustLimits; %#ok<NASGU>
            l_ = L2*0.5;
            x = state(1);
            y = state(2);
            t = state(3);
